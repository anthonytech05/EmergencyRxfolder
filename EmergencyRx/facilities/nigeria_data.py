"""Canonical dataset of Nigeria's 36 states + FCT and their Local Government Areas.

Single source of truth for every state/LGA dropdown in the project (facility
search, leaderboard, facility registration) so users can always pick their
location from a list instead of typing it, even if they can't recall the
exact LGA spelling.
"""
...
NIGERIA_STATES_LGAS = {
    ...
    'FCT': ['Abaji', 'Abuja Municipal (AMAC)', 'Bwari', 'Gwagwalada', 'Kuje', 'Kwali'],
    'Gombe': [
    ...
    'Taraba': [
        ...
        'Karim Lamido', 'Kurmi', 'Lau', 'Sardauna', 'Takum', 'Ussa', 'Wukari', 'Yorro',
        'Zing',
    ],
    'Yobe': [
...
NIGERIA_STATES = sorted(NIGERIA_STATES_LGAS.keys())
